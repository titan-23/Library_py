...
class ModInt998244353:
  ...
  def __init__(self, val: int) -> None:
    self.val = val if 0 <= val < _titan_pylib_ModInt998244353_MOD else val % _titan_pylib_ModInt998244353_MOD
  ...
  def __pow__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    return ModInt998244353(pow(self.val, int(other), _titan_pylib_ModInt998244353_MOD))
  ...
  def __rpow__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    return ModInt998244353(pow(int(other), self.val, _titan_pylib_ModInt998244353_MOD))
