# from titan_pylib.math.mod_int_1000000007 import ModInt1000000007
from typing import Union
_titan_pylib_ModInt1000000007_MOD = 1000000007
...
class ModInt1000000007:
  ...
  def _inv(a: int) -> int:
    res = 1
    b = _titan_pylib_ModInt1000000007_MOD - 2
    while b:
      if b & 1:
        res = res * a % _titan_pylib_ModInt1000000007_MOD
      a = a * a % _titan_pylib_ModInt1000000007_MOD
      b >>= 1
    return res

  @staticmethod
  def get_mod() -> int:
    return _titan_pylib_ModInt1000000007_MOD

  def __init__(self, val: int) -> None:
    self.val = val if 0 <= val < _titan_pylib_ModInt1000000007_MOD else val % _titan_pylib_ModInt1000000007_MOD
  ...
  def __pow__(self, other: Union[int, 'ModInt1000000007']) -> 'ModInt1000000007':
    return ModInt1000000007(pow(self.val, int(other), _titan_pylib_ModInt1000000007_MOD))
  ...
  def __iadd__(self, other: Union[int, 'ModInt1000000007']) -> 'ModInt1000000007':
    self.val += int(other)
    self.val %= _titan_pylib_ModInt1000000007_MOD
    return self
  ...
  def __ipow__(self, other: Union[int, 'ModInt1000000007']) -> 'ModInt1000000007':
    self.val = pow(self.val, int(other), _titan_pylib_ModInt1000000007_MOD)
    return self
  ...
  def __rpow__(self, other: Union[int, 'ModInt1000000007']) -> 'ModInt1000000007':
    return ModInt1000000007(pow(int(other), self.val, _titan_pylib_ModInt1000000007_MOD))
