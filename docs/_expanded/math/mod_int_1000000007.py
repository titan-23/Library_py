...
class ModInt1000000007:
    ...
    def __init__(self, val: int) -> None:
        self.val = (
            val
            if 0 <= val < _titan_pylib_ModInt1000000007_MOD
            else val % _titan_pylib_ModInt1000000007_MOD
        )
    ...
    def __pow__(self, other: Union[int, "ModInt1000000007"]) -> "ModInt1000000007":
        return ModInt1000000007(
            pow(self.val, int(other), _titan_pylib_ModInt1000000007_MOD)
        )
    ...
    def __rpow__(self, other: Union[int, "ModInt1000000007"]) -> "ModInt1000000007":
        return ModInt1000000007(
            pow(int(other), self.val, _titan_pylib_ModInt1000000007_MOD)
        )
