# from Library_py.Math.ModInt998244353 import ModInt998244353
from typing import Union
_titan23_ModInt998244353_MOD = 998244353
...
class ModInt998244353:
  ...
  @staticmethod
  def _inv(a: int) -> int:
    res = a % _titan23_ModInt998244353_MOD
    a = a * a % _titan23_ModInt998244353_MOD
    res = res * a % _titan23_ModInt998244353_MOD
    a = a * a % _titan23_ModInt998244353_MOD
    res = res * a % _titan23_ModInt998244353_MOD
    a = a * a % _titan23_ModInt998244353_MOD
    res = res * a % _titan23_ModInt998244353_MOD
  ...
  @staticmethod
  def get_mod() -> int:
    return _titan23_ModInt998244353_MOD

  def __init__(self, val: int) -> None:
    self.val = val if 0 <= val < _titan23_ModInt998244353_MOD else val % _titan23_ModInt998244353_MOD
  ...
  def __pow__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    return ModInt998244353(pow(self.val, int(other), _titan23_ModInt998244353_MOD))
  ...
  def __iadd__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    self.val += int(other)
    self.val %= _titan23_ModInt998244353_MOD
    return self
  ...
  def __ipow__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    self.val = pow(self.val, int(other), _titan23_ModInt998244353_MOD)
    return self
  ...
  def __rpow__(self, other: Union[int, 'ModInt998244353']) -> 'ModInt998244353':
    return ModInt998244353(pow(int(other), self.val, _titan23_ModInt998244353_MOD))
